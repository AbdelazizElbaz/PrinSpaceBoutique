...
export const plans: Plan[] = [
  {
    ...
    includes: ["الطلبيات والعروض والنماذج وتتبع الإنتاج", "الزبناء والتسبيقات والتعديلات والمتبقي للدفع", "التوصيل مع الوصولات والملصقات", "لوحة القيادة وكشوف الحساب", "وكيل الطباعة على جهاز واحد", "دعم بالبريد الإلكتروني"],
  ...
  },
  {
    ...
    includes: ["كل ما في Starter، بالإضافة إلى:", "مطابقة تلقائية للدفع عند الاستلام مع تنبيه بالفرق", "برنامج الولاء وأكواد الخصم", "متجر إلكتروني عمومي متزامن", "وكيل الطباعة على أجهزة غير محدودة (وضع الخدمة)", "تصدير CSV محاسبي", "دعم ذو أولوية بالبريد + واتساب"],
    cta: "ابدأ التجربة المجانية",
  },
  {
    code: "business",
...
export const comparison: CompareGroup[] = [
  {
    ...
    rows: [
      ...
      { feature: "أجهزة بوكيل الطباعة", starter: "1", pro: "غير محدودة", business: "غير محدودة" },
    ],
  },
  {
