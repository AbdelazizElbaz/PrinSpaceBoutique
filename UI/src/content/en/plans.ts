...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "PrintiosSync on unlimited workstations (service mode)",
...
export const comparison: CompareGroup[] = [
  {
    ...
    rows: [
      ...
      { feature: "Workstations with PrintiosSync", starter: "1", pro: "Unlimited", business: "Unlimited" },
    ],
  },
  {
