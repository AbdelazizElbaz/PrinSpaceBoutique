...
export const legal: LegalContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { h: "4. Hosting and security", p: ["The service is hosted on a Amazon Web Services (AWS) infrastructure with secure connection only. Passwords are never stored in clear text. PrintiosSync access can be revoked at any time. Backups are encrypted."] },
