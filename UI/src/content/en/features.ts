...
export const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "When an order goes into production, its files are marked \"ready\". The print agent installed on each workstation downloads them in the background into the right folder, even when nobody is logged in. No more USB sticks, no more files sent on WhatsApp.",
...
export const testimonials: Testimonial[] = [
  ...
  { name: "Example — Signage in Rabat", role: "Production manager", text: "The print agent runs as a service on the machine's workstation: the files are already there when the operator arrives." },
