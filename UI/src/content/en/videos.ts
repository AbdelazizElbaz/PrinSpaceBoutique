...
export const tracks: Track[] = [
  ...
  { id: "produire", title: "Produce", audience: "Workshop", description: "Install the print agent and receive files automatically." },
...
export const videos: Video[] = [
  ...
  { id: "installer-agent", track: "produire", title: "Install the print agent on a workstation", duration: "5 min", youtubeId: "", summary: "Download the installer, create a service account and connect the agent.", script: [
