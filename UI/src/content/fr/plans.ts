...
export const plans: Plan[] = [
  {
    ...
    includes: [
      ...
      "Agent d'impression sur 1 poste",
      "Support par e-mail",
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "Agent d'impression sur postes illimités (mode service)",
...
export const comparison: CompareGroup[] = [
  {
    ...
    rows: [
      ...
      { feature: "Postes avec agent d'impression", starter: "1", pro: "Illimités", business: "Illimités" },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Agent d'impression Windows / macOS / Linux", starter: true, pro: true, business: true },
