...
export const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Quand une commande passe en production, ses fichiers sont marqués « prêts ». PrintiosSync installé sur chaque poste les télécharge en arrière-plan dans le bon dossier, même quand personne n'est connecté. Plus de clés USB, plus de fichiers envoyés par WhatsApp.",
    bullets: [
...
export const testimonials = [
  ...
  },
  {
    ...
    text: "PrintiosSync tourne en service sur le poste de la machine : les fichiers sont déjà là quand l'opérateur arrive.",
  },
  {
