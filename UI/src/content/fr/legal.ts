...
export const legal: LegalContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { h: "4. Hébergement et sécurité", p: ["Le service est hébergé sur une infrastructure Amazon Web Services (AWS) avec connexion sécurisée. Les mots de passe ne sont jamais stockés en clair. Les accès de PrintiosSync sont révocables à tout moment. Les sauvegardes sont chiffrées."] },
